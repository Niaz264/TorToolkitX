...
class Commands:
    ...
    INSTADL = os.environ.get("INSTADL_CMD")
    START = os.environ.get("START_CMD")
    USTATUS = os.environ.get("USTATUS_CMD")
    SETTHUMB = os.environ.get("SETTHUMB_CMD")
    CLRTHUMB = os.environ.get("CLRTHUMB_CMD")
    SPEEDTEST = os.environ.get("SPEEDTEST_CMD")
